...
public class Contants {
    ...
    public static final String TOKEN_RESPONSE_ERROR_MESSAGE = "Un error ha ocurrido con el token.";
    public static final String NO_DATA_FOUND_MESSAGE = "Datos no encontrados.";
    public static final String USER_ALREADY_EXISTS_MESSAGE = "El usuario ya existe en el sistema.";
